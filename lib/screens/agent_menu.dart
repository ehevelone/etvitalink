...
class _AgentMenuScreenState extends State<AgentMenuScreen> {
  ...
  Future<void> _loadProfile() async {
    ...
    String? storedName = await store.getString("agentName");

    if (!mounted) return;
    setState(() {
      _p = p;
      _fallbackName = storedName?.isNotEmpty == true ? storedName! : "Agent";
      _loading = false;
    });
  }
  ...
  Widget build(BuildContext context) {
    // ✅ Prefer Profile fullName, fallback to SecureStore
    final displayName = _p?.fullName?.isNotEmpty == true ? _p!.fullName : _fallbackName;
          ...
          children: [
            ...
            Column(
              children: [
                    ...
                    children: [
                      Card(
                        child: ListTile(
                          ...
                          title: const Text("My Agent Profile"),
                          onTap: () =>
                              Navigator.pushNamed(context, '/my_agent_agent'),
                        ),
                      ),
                      Card(
                        child: ListTile(
                ...
                // ✅ Bottom buttons with safe padding
                SafeArea(
                  top: false,
