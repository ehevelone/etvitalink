...
class _MyAgentAgentState extends State<MyAgentAgent> {
  ...
  String? _agentEmail;
  String? _agentPhone;
  String? _agentNpn; // kept, just not displayed
  String? _agencyName;
  ...
  Future<void> _loadAgentInfo() async {
    ...
    _agentNpn = await store.getString("agentNpn"); // 🟢 REMAINS but never shown
    ...
    try {
      ...
      if (res['success'] == true) {
        ...
        _promoCode = code;
        _deepLink = "https://vitalink-app.netlify.app/onboard?code=$code";
      }
    } catch (_) {}
    ...
    if (_promoCode == null && stored != null) {
      _promoCode = stored;
      _deepLink = "https://vitalink-app.netlify.app/onboard?code=$stored";
    }
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          // ❌ NPN removed permanently — never displayed
