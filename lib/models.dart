...
class InsuranceCard {
  ...
  String memberId;
  String policyType;
  String frontImagePath;   // ✅ always required
  String? backImagePath;   // optional
  ...
  factory InsuranceCard.fromJson(Map<String, dynamic> json) => InsuranceCard(
        ...
        frontImagePath: json['frontImagePath'] ?? '', // ✅ ensure non-null
...
extension ProfileHelpers on Profile {
  String get displayName {
    if (fullName.isNotEmpty) {
      return fullName;
    } else if (agentName != null && agentName!.isNotEmpty) {
      return agentName!;
    }
